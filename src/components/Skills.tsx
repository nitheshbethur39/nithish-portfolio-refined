      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skillCategories.map((category, index) => (
            <div key={index} className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300">
          ...
          <div className="bg-slate-800/30 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/30">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                <h4 className="text-lg font-semibold text-slate-300 mb-3">Statistical Analysis</h4>
              ...
              <div className="text-center">
                <h4 className="text-lg font-semibold text-slate-300 mb-3">Domain Knowledge</h4>
                <ul className="text-slate-400 text-sm space-y-1">
              ...
              <div className="text-center">
                <h4 className="text-lg font-semibold text-slate-300 mb-3">Soft Skills</h4>
                <ul className="text-slate-400 text-sm space-y-1">
              ...
              <div className="text-center">
                <h4 className="text-lg font-semibold text-slate-300 mb-3">Methodologies</h4>
                <ul className="text-slate-400 text-sm space-y-1">
                  <li>Agile/Scrum</li>
                  <li>CI/CD</li>
                  <li>A/B Testing</li>
