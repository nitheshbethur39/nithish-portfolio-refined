  ...
  return (
    <section id="contact" className="py-20 px-6 lg:px-8 bg-gradient-to-b from-slate-900 to-slate-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-20 left-10 w-32 h-32 bg-light-teal/10 rounded-full blur-xl animate-float" />
        <div className="absolute bottom-32 right-20 w-24 h-24 bg-blue-gray/10 rounded-full blur-xl animate-float delay-1000" />
        <div className="absolute top-1/2 left-1/3 w-16 h-16 bg-light-teal/20 rounded-full blur-lg animate-pulse" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-light-teal to-blue-gray mx-auto mb-8 rounded-full animate-scale-in delay-500" />
          <p className="text-base text-blue-gray max-w-2xl mx-auto font-chivo font-light animate-fade-in delay-700">
            Ready to discuss data engineering opportunities, cloud architecture projects, or AWS consulting? I'm actively seeking full-time roles and would love to hear from you.
          </p>
        </div>
          ...
          <div className="animate-slide-in-left delay-300">
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-light-teal/10 to-blue-gray/10 rounded-xl border border-light-teal/20 animate-fade-in delay-1000">
              ...
              <p className="text-blue-gray mb-4 text-sm font-chivo font-light animate-fade-in delay-200">
                I'm actively seeking full-time opportunities in data engineering, cloud architecture, and analytics roles. Let's discuss how my AWS expertise and data engineering experience can drive your organization's success.
              </p>
            ...
            <form onSubmit={handleSubmit} ref={formRef} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="animate-fade-in-up delay-300">
                  <label htmlFor="name" className="block text-blue-gray font-chivo font-medium mb-2 text-sm">Name *</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
                ...
                <div className="animate-fade-in-up delay-400">
                  <label htmlFor="email" className="block text-blue-gray font-chivo font-medium mb-2 text-sm">Email *</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
              ...
              <div className="animate-fade-in-up delay-500">
                <label htmlFor="subject" className="block text-blue-gray font-chivo font-medium mb-2 text-sm">Subject *</label>
                <input
                  type="text"
                  id="subject"
                  name="subject"
              ...
              <div className="animate-fade-in-up delay-600">
                <label htmlFor="message" className="block text-blue-gray font-chivo font-medium mb-2 text-sm">Message *</label>
                <textarea
                  id="message"
                  name="message"
